...
CLASSICAL_DISPLAY_NAME = "Replicate-Dictionary Pair NNLS"
DEEP_DISPLAY_NAME = "Similarity-Supervised Coefficient Regressor"
...
\textbf{{Selected classical model family.}} {tex_escape(CLASSICAL_DISPLAY_NAME)}. Selected run: {tex_escape(best_classical_name)}. Candidate scores on the same mixture-only set: {tex_escape(classical_note)}.

\textbf{{Selected deep model family.}} {tex_escape(DEEP_DISPLAY_NAME)}. Selected run: {tex_escape(best_deep_name)}. Candidate scores on the same mixture-only set: {tex_escape(deep_note)}.
...
def main() -> None:
    ...
    model_frames = {
        ...
        CLASSICAL_DISPLAY_NAME: classical_frames[best_classical_name],
        DEEP_DISPLAY_NAME: deep_frames[best_deep_name],
    }
    ...
    merged["support"] = per_class_by_model[CLASSICAL_DISPLAY_NAME]["support"]
