        ...
        rows.append(
            {
                ...
                "parser_id": "atlas_native_source_parser",
                "parser_version": "1",
                "coordinate_unit": "cm^-1",
                "intensity_unit": "arbitrary_unit",
                "has_binary_source": bool(source["binary_relative_path"]),
                "has_report_source": bool(source["report_relative_path"]),
                "has_probe_source": bool(source["probe_relative_path"]),
                "has_dark_source": bool(source["dark_relative_path"]),
